...
| holosoma | https://github.com/amazon-far/holosoma | `6e146b0af5d7cd8a39b8bb2ed05b977cf70445d3` (2026-08-11) | Apache-2.0 | Primary RL baseline (FastSAC/PPO, MJWarp/IsaacSim, DR, terrain, pushes). Lives in WSL2 at `~/holosoma`, not in this tree; local patch: see docs/tooling.md |
